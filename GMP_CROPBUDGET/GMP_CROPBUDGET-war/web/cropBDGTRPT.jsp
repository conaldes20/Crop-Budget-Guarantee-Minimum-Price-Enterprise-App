      ...
      <table width="936" border="0" align="center">
        ...
        <tr>
          ...
          <table width="928" border="1">
            ...
            <tr>
              <td width="117" height="23" class="font2">Return to management 100%</td>
              <td class="font2"></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
              <td class="coloam"><div align="right"></div></td>
            ...
            <tr>
              <td height="23" class="font2">Interest rate 10%</td>
              <td class="font2"></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
              <td class="coloam"><div align="right"></div></td>
            ...
            <tr>
              <td width="117" height="23" class="font2">6 months gestation period (planting to harvest)</td>
              <td class="font2"></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
              <td class="coloam"><div align="right"></div></td>
            ...
            <tr>
              <td height="24" class="font2">AMR ( b)</td>
              <td class="font2"><table cellspacing="0" cellpadding="0">
                <tr>
                  <td width="127">100%+(6/12*10/100)</td>
                </tr>
              </table></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
            ...
            <tr>
              <td width="117" class="font2">AMRR (c)=a*b</td>
              <td class="font2"></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
            ...
            <tr>
              <td width="117" class="font2">Yield per hectare</td>
              <td class="font2"><div align="center">2</div></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
              <td class="coloam"><div align="right"></div></td>
              <td></td>
            ...
            <tr>
              <td></td>
              <td class="font2">Dividing by yield (d)=c/2</td>
              <td class="font2"></td>
              <td><div align="center"></div></td>
              <td class="coloam"><div align="right"></div></td>
            ...
            <tr>
              <td><table cellspacing="0" cellpadding="0">
                <tr>
                  <td width="113" class="font3"><p>Recommended /Proposed GMP</p></td>
                </tr>
              </table></td>
